...
namespace SIL.Chono
{
	partial class ChonoInfo
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ChonoInfo));
			...
			this.l10NSharpExtender1.SetLocalizingId(lblProductName, "ChonoInfo.lblProductName");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.pictLogo, "ChonoInfo.pictLogo");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.m_lblAppVersion, "ChonoInfo.m_lblAppVersion");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.m_lblCopyright, "ChonoInfo.m_lblCopyright");
			...
			this.m_lblCopyright.Text = "(C) 2021, SIL International.";
			this.m_lblCopyright.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// m_picLogo
			// 
			this.m_picLogo.Image = global::SIL.Chono.Properties.Resources.Chono;
			...
			this.l10NSharpExtender1.SetLocalizingId(this.m_picLogo, "ChonoInfo.m_picLogo");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.lblBuildDate, "ChonoInfo.lblBuildDate");
			...
			this.l10NSharpExtender1.SetLocalizingId(this, "ChonoInfo.ChonoInfo");
			this.Name = "ChonoInfo";
