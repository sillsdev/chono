namespace SIL.Chono
{
	partial class ShowSpeakersControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.l10NSharpExtender1.SetLocalizingId(this.colCharacterId, "Chono.colCharacterId");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.colAlias, "Chono.colAlias");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.colDelivery, "Chono.colDelivery");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.colType, "Chono.colType");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.colParallelPassage, "Chono.colParallelPassage");
			...
			this.l10NSharpExtender1.SetLocalizingId(this.colLocalizedCharacter, "Chono.colLocalizedCharacter");
			...
			this.l10NSharpExtender1.PrefixForNewItems = "Chono";
			// 
			// ShowSpeakersControl
			// 
			...
			this.l10NSharpExtender1.SetLocalizingId(this, "Chono.ShowSpeakersControl.ShowSpeakersControl");
