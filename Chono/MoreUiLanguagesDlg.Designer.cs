namespace SIL.Chono
{
	partial class MoreUiLanguagesDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.l10NSharpExtender1.SetLocalizationComment(this.m_linkLabelCrowdinInformation, "Param 0: \"Chono\" (plugin name); Param 1: \"Crowdin\" (website) - will be f" +
        "ormatted as a hyperlink to crowdin.com");
			...
			this.m_linkLabelCrowdinInformation.Tag = "https://crowdin.com/project/chono";
			...
			this.m_linkLabelAddDisplayLanguageUsingInstaller.Tag = "https://software.sil.org/chono/download/";
